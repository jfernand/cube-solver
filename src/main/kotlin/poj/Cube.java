...
public class Cube {
    ...
    public static final String FELIKS = "U2 F L2 U2 R2 F L2 F2 L' D' B2 R D2 R' B' U' L' B'";
    ...
    public Cube() {
        ...
        cubiePos[1][1][1] = new Cubie(1,
            1,
            1,
            new CubieColor[]{new CubieColor('A', 'A')},
            //Just giving random, non-legitimate values for color and direction
            false,
            false
        );
    ...
    private Cubie[][] rotateMatrix(
        Cubie[][] orig, int degrees, char[] preChange,
        char[] postChange
    ) {
    ...
    public String finishWhiteLayer() {
        ...
        moves += "[miso corners 1] ";
        while (whiteCornerinU()) {
            moves += insertCornersInU();
            moves += "(corners2) ";
            moves += insertMisorientedCorners();
            moves += "[miso corners 2]";
        }
        return optimizeMoves(moves);
    }
...
moves += "(prepare white corner)";
    ...
    public static void main(String[] args) {
        Cube cube = new Cube();
        cube.scramble(FELIKS);
        System.out.println("Sunflower: " + cube.makeSunflower());
        System.out.println("White Cross: " + cube.makeWhiteCross());
        System.out.println("White Layer: " + cube.finishWhiteLayer());
    }
}
